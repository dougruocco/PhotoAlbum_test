...
{
    UIAlertView *newAblumAlertView = [[UIAlertView alloc] initWithTitle:@"Enter New Album Name" message:nil delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Add", nil];
    [newAblumAlertView setAlertViewStyle:UIAlertViewStylePlainTextInput];
    [newAblumAlertView show];
}
